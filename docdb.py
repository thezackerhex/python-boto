...
def main():
    ...
    print_string_hdr = "account,Database,DbVersion,InstanceType,Retention_Period,InstanceIdentifier\n"
    ...
    for account in validated_accounts:
        ...
        for region in regions:
            ...
            Engine = EngineVersion = status = Instance_type = Arn = Retention_Period = InstanceIdentifier = ""
            for key1, value1 in response.items():
				...
				Instance_type = str(instance_type)
                            ...
                            if key2 == "DBInstanceIdentifier":
                                InstanceIdentifier = value2
                        print_string = account + "," + Engine + "," + EngineVersion + "," + Instance_type + "," + Retention_Period + "," + InstanceIdentifier 
